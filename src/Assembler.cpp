...
//	a.printAll();
    ...
    HashTable<string , operationInfo> table;
    operationInfo*  opInfo = new operationInfo();
  //  cout << opInfo->directive <<" "<<opInfo->howManyOperand <<" "<<opInfo->operationName <<" "<<opInfo->operationName <<endl;
//   operationInfo*  opInfo = new operationInfo();
>>>>>>> 5e32d3166c019ff6957560a0657cdc6c1651d807
